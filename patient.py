...
def show_patient_details(list_of_patients):
    patient_titles = ['Patient ID', 'Name', 'Age', 'Gender', 'Date of birth (DD-MM-YYYY)',
                     ...
                     'City', 'State', 'PIN code', "emergency contact name",
...
class Patient:
    ...
    def add_patient(self):
        ...
        self.next_of_kin_name = st.text_input("Emergency Contact's Name")
        self.next_of_kin_relation_to_patient = st.text_input("Emergency Contact's relation to patient")
        self.next_of_kin_contact_number = st.text_input("Emergency contact number")
    ...
    def update_patient(self):
        ...
        if id == '':
            ...
            self.state = st.text_input('State')
            self.pin_code = st.text_input('PIN code')
            self.next_of_kin_name = st.text_input("emergency contact name")
            self.next_of_kin_relation_to_patient = st.text_input("emergency contact relation")
            self.next_of_kin_contact_number = st.text_input("emergency contact number")
            email_id = st.text_input('Email ID (optional)')
            self.email_id = (lambda email : None if email == '' else email)(email_id)
